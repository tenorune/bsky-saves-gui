    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          theme_color: '#ffffff',
          // PNG icons first — Safari Add-to-Dock prefers raster and falls
          // back to favicon if the manifest only advertises SVG.
          // Regenerate with: node tools/build-pwa-icons.mjs
          icons: [
